...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const rules = JSON.parse(fs_1.default.readFileSync(fileUrl).toString());
            core.debug(`Got all rules from file ${fileUrl}`);
            const activeRule = rules.find(a => a.id === ruleId);
            core.debug(`Found active rule: ${activeRule ? JSON.stringify(activeRule) : '-'}`);
            const isEligibleActor = activeRule === null || activeRule === void 0 ? void 0 : activeRule.eligibleActors.includes(actor);
            core.setOutput('isEligibleActor', isEligibleActor);
            if (!isEligibleActor && !(activeRule === null || activeRule === void 0 ? void 0 : activeRule.failSilently)) {
                core.setFailed((activeRule === null || activeRule === void 0 ? void 0 : activeRule.failureMessage) ||
